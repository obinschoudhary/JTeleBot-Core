 ...
 *
 */
package com.nixtabyte.telegram.jtelebot.mapper.json;
...
import com.nixabyte.telegram.jtelebot.mapper.json.MapperHandler;
import com.nixabyte.telegram.jtelebot.response.json.Audio;
import com.nixabyte.telegram.jtelebot.response.json.Contact;
import com.nixabyte.telegram.jtelebot.response.json.Document;
import com.nixabyte.telegram.jtelebot.response.json.ForceReply;
import com.nixabyte.telegram.jtelebot.response.json.GroupChat;
import com.nixabyte.telegram.jtelebot.response.json.Location;
import com.nixabyte.telegram.jtelebot.response.json.Message;
import com.nixabyte.telegram.jtelebot.response.json.PhotoSize;
import com.nixabyte.telegram.jtelebot.response.json.ReplyKeyboardHide;
import com.nixabyte.telegram.jtelebot.response.json.ReplyKeyboardMarkup;
import com.nixabyte.telegram.jtelebot.response.json.Sticker;
import com.nixabyte.telegram.jtelebot.response.json.TelegramResponse;
import com.nixabyte.telegram.jtelebot.response.json.Update;
import com.nixabyte.telegram.jtelebot.response.json.User;
import com.nixabyte.telegram.jtelebot.response.json.UserProfilePhotos;
import com.nixabyte.telegram.jtelebot.response.json.Video;
