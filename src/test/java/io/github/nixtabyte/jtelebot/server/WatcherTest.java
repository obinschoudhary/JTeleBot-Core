...
import io.github.nixtabyte.jtelebot.server.impl.DefaultCommandDispatcher;
import io.github.nixtabyte.jtelebot.server.impl.DefaultCommandQueue;
import io.github.nixtabyte.jtelebot.server.impl.DefaultCommandWatcher;
...
public class WatcherTest {
	...
	public void setUp() {
		...
		commandWatcher = new DefaultCommandWatcher(POLLING_DELAY,
				...
				new DummyCommandFactoryImpl(), null);
