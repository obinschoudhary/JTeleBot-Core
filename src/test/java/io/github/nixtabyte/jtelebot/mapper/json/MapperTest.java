 ...
 *
 */
package io.github.nixtabyte.jtelebot.mapper.json;

import static org.junit.Assert.*;
import io.github.nixtabyte.jtelebot.mapper.json.MapperHandler;
import io.github.nixtabyte.jtelebot.response.json.Audio;
import io.github.nixtabyte.jtelebot.response.json.Contact;
import io.github.nixtabyte.jtelebot.response.json.Document;
import io.github.nixtabyte.jtelebot.response.json.ForceReply;
import io.github.nixtabyte.jtelebot.response.json.GroupChat;
import io.github.nixtabyte.jtelebot.response.json.Location;
import io.github.nixtabyte.jtelebot.response.json.Message;
import io.github.nixtabyte.jtelebot.response.json.PhotoSize;
import io.github.nixtabyte.jtelebot.response.json.ReplyKeyboardHide;
import io.github.nixtabyte.jtelebot.response.json.ReplyKeyboardMarkup;
import io.github.nixtabyte.jtelebot.response.json.Sticker;
import io.github.nixtabyte.jtelebot.response.json.TelegramResponse;
import io.github.nixtabyte.jtelebot.response.json.Update;
import io.github.nixtabyte.jtelebot.response.json.User;
import io.github.nixtabyte.jtelebot.response.json.UserProfilePhotos;
import io.github.nixtabyte.jtelebot.response.json.Video;
